...
DISCLAIMER = (
    ...
    "[OpenPak/flatpak-external-data-checker]"
    "(https://github.com/OpenPak/flatpak-external-data-checker). "
    "Please [open an issue]"
    "(https://github.com/OpenPak/flatpak-external-data-checker/issues/new) "
